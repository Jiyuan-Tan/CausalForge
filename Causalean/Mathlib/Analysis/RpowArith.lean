...
exponents. The main lemmas identify reciprocal natural casts with real powers
(`natCast_inv_eq_rpow_neg_one`), factor `(A / n) ^ (p / 2)` into an `A` part
and an `n` part (`div_natCast_rpow`), bound nonpositive powers of natural casts
