...
structure, allowing its transcendence degree to be formed locally. -/
...
theorem coordinateSubalgebra_trdeg_le_of_polynomial_factorization
  ...
  change @Algebra.trdeg ℂ A _ _ (Subalgebra.algebra A) ≤ Fintype.card τ
