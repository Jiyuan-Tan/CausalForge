...
\title{causalsmith Stage -1 proposal: \texttt{__QID__} / \texttt{__SPECIALIZATION__}%
...
%   assignment, target, regression) precisely for qid=__QID__
%   specialization=__SPECIALIZATION__. For a free-form qid (the
