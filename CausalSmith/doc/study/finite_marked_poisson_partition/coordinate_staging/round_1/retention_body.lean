...
/-!
# Retained prefixes of marked Poisson samples

This file retains the observations with the smallest independent marks in a
finite marked Poisson sample. Conditional on there being enough points, the
retained observations have exactly the desired finite i.i.d. product law.
-/
...
private lemma retainedObservations_fixedSizeEmbed_eq
  ...
  funext k
  simp only [retainedObservations, fixedSizeEmbed, FiniteSample.count, dif_pos h]
