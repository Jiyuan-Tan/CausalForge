...
/-!
# Restriction to a finite measurable partition

This file represents a finite measurable partition by its measurable cell
classifier. It defines cell masses, normalized within-cell laws, and measurable
restriction maps for finite marked sequences. The exact Poisson splitting law
is proved in the companion `Partition.Splitting` module.
-/
