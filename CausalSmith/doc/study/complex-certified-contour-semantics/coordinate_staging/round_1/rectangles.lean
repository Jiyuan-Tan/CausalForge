...
private theorem rat_sq_width_le (K : RatInterval) :
...
private theorem rat_sq_hi_le (K : RatInterval) : K.sq.hi ≤ K.maxAbs ^ 2 := by
...
private theorem rat_maxAbs_mono {K L : RatInterval} (hKL : K.Subinterval L) :
