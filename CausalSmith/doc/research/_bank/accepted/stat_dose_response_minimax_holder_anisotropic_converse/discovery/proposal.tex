...
%  Locked parameters: qid=stat\_dose\_response\_minimax, specialization=holder\_anisotropic\_converse
%
...
\title{thmsmith Stage -1 proposal: \texttt{stat\_dose\_response\_minimax} / \texttt{holder\_anisotropic\_converse}%
...
%   assignment, target, regression) precisely for qid=stat\_dose\_response\_minimax
%   specialization=holder\_anisotropic\_converse. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
