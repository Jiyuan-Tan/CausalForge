...
%  Locked parameters: qid=stat\_discrete\_ate\_minimax\_loggap, specialization=polynomial\_upper\_match
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_discrete\_ate\_minimax\_loggap} / \texttt{polynomial\_upper\_match}%
...
%   assignment, target, regression) precisely for qid=stat\_discrete\_ate\_minimax\_loggap
%   specialization=polynomial\_upper\_match. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
