...
%  Locked parameters: qid=stat\_transported\_late\_strength\_frontier, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_transported\_late\_strength\_frontier} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_transported\_late\_strength\_frontier
%   specialization=v1. For a free-form qid (the
