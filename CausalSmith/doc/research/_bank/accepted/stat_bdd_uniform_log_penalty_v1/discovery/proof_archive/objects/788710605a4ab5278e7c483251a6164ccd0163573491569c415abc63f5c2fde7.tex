...
Continue with \(h=h_n=a_n\) and set \(B=B_n=a_n^{-1/3}\).  Separately from the two bias-interface limits checked above, the regime required by the established maximal inequalities holds because
\[
