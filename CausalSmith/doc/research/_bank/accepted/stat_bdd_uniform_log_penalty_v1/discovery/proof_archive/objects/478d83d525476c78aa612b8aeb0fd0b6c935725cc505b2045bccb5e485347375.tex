...
\[
 ...
 =a_{c,r}^{\top}e_4=1,
\]
a contradiction.  Thus no four planar points are shattered by closed Euclidean balls.  Their VC dimension is at most three and their VC index at most four.  Restriction to \(\mathcal X_P\) cannot increase the index.  Because Euclidean distance and \(K_\square(u)=\mathbf1\{|u|\leq1\}\) generate precisely these restricted sublevel sets, the VC clause in \(\mathrm{def:cty\text{-}a1\text{-}a2\text{-}class}\) follows uniformly.