...
\[
 ...
 M_n\geq c_0a_n^{-1/q},
\]
where all constants may depend only on \(q\) and \(L\).  In particular, the separation is a constant multiple of \(a_n^{1/q}\).  Write \(r_j(z)=\lVert z-x_j\rVert_2\) and \(\phi_j(z)=\phi((z-x_j)/w)\).
