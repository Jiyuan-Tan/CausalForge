...
%  Locked parameters: qid=panel\_ppml\_forbidden\_comparison, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{panel\_ppml\_forbidden\_comparison} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=panel\_ppml\_forbidden\_comparison
%   specialization=v1. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
