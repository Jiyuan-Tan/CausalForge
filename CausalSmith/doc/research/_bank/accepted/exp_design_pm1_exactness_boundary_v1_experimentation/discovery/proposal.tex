...
%  Locked parameters: qid=exp\_design\_pm1\_exactness\_boundary\_v1, specialization=experimentation
%
...
\title{thmsmith Stage -1 proposal: \texttt{exp\_design\_pm1\_exactness\_boundary\_v1} / \texttt{experimentation}%
...
%   assignment, target, regression) precisely for qid=exp\_design\_pm1\_exactness\_boundary\_v1
%   specialization=experimentation. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
