...
%  Locked parameters: qid=eid\_lingam\_direction\_min\_order\_v1, specialization=truncated\_cumulant\_minimality
%
...
\title{thmsmith Stage -1 proposal: \texttt{eid\_lingam\_direction\_min\_order\_v1} / \texttt{truncated\_cumulant\_minimality}%
...
%   assignment, target, regression) precisely for qid=eid\_lingam\_direction\_min\_order\_v1
%   specialization=truncated\_cumulant\_minimality. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
