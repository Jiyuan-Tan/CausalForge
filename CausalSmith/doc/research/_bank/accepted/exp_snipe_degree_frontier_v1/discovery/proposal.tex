...
%  Locked parameters: qid=exp\_snipe\_degree\_frontier, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{exp\_snipe\_degree\_frontier} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=exp\_snipe\_degree\_frontier
