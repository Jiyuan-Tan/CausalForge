...
%  Locked parameters: qid=exp\_bipartite\_minimax\_design, specialization=v1
%
...
\title{thmsmith Stage -1 proposal: \texttt{exp\_bipartite\_minimax\_design} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=exp\_bipartite\_minimax\_design
