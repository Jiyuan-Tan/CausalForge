...
%  Locked parameters: qid=stat\_trae\_adaptive\_misspecification, specialization=deepiv\_robust\_v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_trae\_adaptive\_misspecification} / \texttt{deepiv\_robust\_v1}%
...
%   assignment, target, regression) precisely for qid=stat\_trae\_adaptive\_misspecification
%   specialization=deepiv\_robust\_v1. For a free-form qid (the
