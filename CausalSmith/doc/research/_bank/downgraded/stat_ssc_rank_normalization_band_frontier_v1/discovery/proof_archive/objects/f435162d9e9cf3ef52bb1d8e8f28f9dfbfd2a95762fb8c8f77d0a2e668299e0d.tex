...
\]
The equality \(\theta^{\mathrm{pop}}_{r,\mathcal G}(g)=\theta(g)\) used here was proved after controlling the interpolation perturbation of the internal \(L^2\) factor map; (1) is not obtained by discarding that perturbation.
