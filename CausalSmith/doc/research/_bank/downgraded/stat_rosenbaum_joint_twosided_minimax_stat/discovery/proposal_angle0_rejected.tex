...
%  Locked parameters: qid=stat\_rosenbaum\_joint\_twosided\_minimax, specialization=stat
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_rosenbaum\_joint\_twosided\_minimax} / \texttt{stat}%
...
%   assignment, target, regression) precisely for qid=stat\_rosenbaum\_joint\_twosided\_minimax
%   specialization=stat. For a free-form qid (the
