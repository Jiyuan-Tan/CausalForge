...
%  Locked parameters: qid=pid\_prte\_gain\_band\_functional, specialization=ot\_band\_dual\_orthogonal
%
...
\title{causalsmith Stage -1 proposal: \texttt{pid\_prte\_gain\_band\_functional} / \texttt{ot\_band\_dual\_orthogonal}%
...
%   assignment, target, regression) precisely for qid=pid\_prte\_gain\_band\_functional
%   specialization=ot\_band\_dual\_orthogonal. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
