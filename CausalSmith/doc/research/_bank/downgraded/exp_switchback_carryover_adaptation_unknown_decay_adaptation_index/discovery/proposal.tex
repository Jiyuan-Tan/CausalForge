...
%  Locked parameters: qid=exp\_switchback\_carryover\_adaptation, specialization=unknown\_decay\_adaptation\_index
%
...
\title{causalsmith Stage -1 proposal: \texttt{exp\_switchback\_carryover\_adaptation} / \texttt{unknown\_decay\_adaptation\_index}%
...
%   assignment, target, regression) precisely for qid=exp\_switchback\_carryover\_adaptation
%   specialization=unknown\_decay\_adaptation\_index. For a free-form qid (the
