...
%  Locked parameters: qid=stat\_gformula\_composition\_minimax, specialization=transition\_smoothness\_elbow
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_gformula\_composition\_minimax} / \texttt{transition\_smoothness\_elbow}%
...
%   assignment, target, regression) precisely for qid=stat\_gformula\_composition\_minimax
%   specialization=transition\_smoothness\_elbow. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
