...
\]
is unchanged, so the deployed policy is unchanged at every context, including contexts absent from the sample. Finally, \(\underline J_n\) is written entirely in terms of prediction values in \(\mathcal Q_n\), the observed contexts, \(\pi_{\mathrm{ref}}\), and \(\eta\). It is therefore unchanged as well. This proves every asserted invariance.