...
%  Locked parameters: qid=stat\_reversekl\_two\_coverage, specialization=linear\_exact\_shell
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_reversekl\_two\_coverage} / \texttt{linear\_exact\_shell}%
...
%   assignment, target, regression) precisely for qid=stat\_reversekl\_two\_coverage
%   specialization=linear\_exact\_shell. For a free-form qid (the
