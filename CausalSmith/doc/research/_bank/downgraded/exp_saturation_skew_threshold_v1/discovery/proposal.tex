...
%  Locked parameters: qid=exp\_saturation\_skew\_threshold, specialization=v1
%
...
\title{thmsmith Stage -1 proposal: \texttt{exp\_saturation\_skew\_threshold} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=exp\_saturation\_skew\_threshold
