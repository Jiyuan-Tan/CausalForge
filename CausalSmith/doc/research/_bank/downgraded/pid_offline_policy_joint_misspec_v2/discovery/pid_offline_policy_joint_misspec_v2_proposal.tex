...
%  Locked parameters: qid=pid\_offline\_policy\_joint\_misspec, specialization=v2
%
...
\title{thmsmith Stage -1 proposal: \texttt{pid\_offline\_policy\_joint\_misspec} / \texttt{v2}%
...
%   assignment, target, regression) precisely for qid=pid\_offline\_policy\_joint\_misspec
%   specialization=v2. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
