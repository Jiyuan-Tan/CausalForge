...
\tag{1}
\]
This already gives the all-design, all-measurable-estimator lower bound. We additionally verify the proposition's unchanged finite posterior claim exactly.
...
\tag{2}
\]
Thus every atom belongs to \(\Theta_{b,s}\). Extend it to a schedule by using the target signs on all-control and isolated-treatment local patterns and zero on every other local pattern. This is exactly construction (2) in the general converse and therefore lies in the published block-clique class.
