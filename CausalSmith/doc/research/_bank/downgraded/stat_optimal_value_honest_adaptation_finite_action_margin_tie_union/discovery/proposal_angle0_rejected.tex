...
%  Locked parameters: qid=stat\_optimal\_value\_honest\_adaptation, specialization=finite\_action\_margin\_tie\_union
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_optimal\_value\_honest\_adaptation} / \texttt{finite\_action\_margin\_tie\_union}%
...
%   assignment, target, regression) precisely for qid=stat\_optimal\_value\_honest\_adaptation
%   specialization=finite\_action\_margin\_tie\_union. For a free-form qid (the
