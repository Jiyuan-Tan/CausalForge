...
%  Locked parameters: qid=exp\_ego\_cluster\_exposure\_clt, specialization=ego\_cluster\_polynomial\_clt
%
...
\title{thmsmith Stage -1 proposal: \texttt{exp\_ego\_cluster\_exposure\_clt} / \texttt{ego\_cluster\_polynomial\_clt}%
...
%   assignment, target, regression) precisely for qid=exp\_ego\_cluster\_exposure\_clt
%   specialization=ego\_cluster\_polynomial\_clt. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
