...
%  Locked parameters: qid=scm\_mediator\_monotonicity\_pn\_v1, specialization=mediator\_defier\_gap
%
...
\title{causalsmith Stage -1 proposal: \texttt{scm\_mediator\_monotonicity\_pn\_v1} / \texttt{mediator\_defier\_gap}%
...
%   assignment, target, regression) precisely for qid=scm\_mediator\_monotonicity\_pn\_v1
%   specialization=mediator\_defier\_gap. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
