...
%  Locked parameters: qid=stat\_plm\_two\_nuisance\_minimax, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_plm\_two\_nuisance\_minimax} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_plm\_two\_nuisance\_minimax
