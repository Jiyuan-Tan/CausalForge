...
%  Locked parameters: qid=stat\_neyman\_regret\_minimax, specialization=adaptive two-arm experiment; first matching minimax lower bound pinning the sharp minimax Neyman-regret rate
%
...
\title{thmsmith Stage -1 proposal: \texttt{stat\_neyman\_regret\_minimax} / \texttt{adaptive two-arm experiment; first matching minimax lower bound pinning the sharp minimax Neyman-regret rate}%
...
%   assignment, target, regression) precisely for qid=stat\_neyman\_regret\_minimax
%   specialization=adaptive two-arm experiment; first matching minimax lower bound pinning the sharp minimax Neyman-regret rate. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
