...
%  Locked parameters: qid=stat\_doseresponse\_minimax\_elbow, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_doseresponse\_minimax\_elbow} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_doseresponse\_minimax\_elbow
