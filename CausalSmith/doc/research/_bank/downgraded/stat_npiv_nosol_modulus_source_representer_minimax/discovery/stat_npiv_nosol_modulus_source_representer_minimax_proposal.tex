...
%  Locked parameters: qid=stat\_npiv\_nosol\_modulus, specialization=source\_representer\_minimax
%
...
\title{thmsmith Stage -1 proposal: \texttt{stat\_npiv\_nosol\_modulus} / \texttt{source\_representer\_minimax}%
...
%   assignment, target, regression) precisely for qid=stat\_npiv\_nosol\_modulus
%   specialization=source\_representer\_minimax. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
