...
%  Locked parameters: qid=eid\_score\_order\_minimax\_gap\_v1, specialization=score\_variance\_gap\_exponent
%
...
\title{causalsmith Stage -1 proposal: \texttt{eid\_score\_order\_minimax\_gap\_v1} / \texttt{score\_variance\_gap\_exponent}%
...
%   assignment, target, regression) precisely for qid=eid\_score\_order\_minimax\_gap\_v1
%   specialization=score\_variance\_gap\_exponent. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
