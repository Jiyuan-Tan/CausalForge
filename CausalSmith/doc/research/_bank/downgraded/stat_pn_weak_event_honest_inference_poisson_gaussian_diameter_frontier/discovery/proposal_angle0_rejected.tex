...
%  Locked parameters: qid=stat\_pn\_weak\_event\_honest\_inference, specialization=poisson\_gaussian\_diameter\_frontier
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_pn\_weak\_event\_honest\_inference} / \texttt{poisson\_gaussian\_diameter\_frontier}%
...
%   assignment, target, regression) precisely for qid=stat\_pn\_weak\_event\_honest\_inference
%   specialization=poisson\_gaussian\_diameter\_frontier. For a free-form qid (the
