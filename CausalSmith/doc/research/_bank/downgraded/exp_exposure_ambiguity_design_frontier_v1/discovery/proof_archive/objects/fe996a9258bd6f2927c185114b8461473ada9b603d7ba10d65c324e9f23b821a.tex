\textbf{Proof.}
Write a no-interference sign schedule as \(\alpha=(b_{i0},b_{i1})_{i\in V_n}\). For schedules \(\alpha\) and \(\beta\), let
\[
 D_0=\{i:b_{i0}^\alpha\ne b_{i0}^\beta\},
 \qquad
 D_1=\{i:b_{i1}^\alpha\ne b_{i1}^\beta\}. \tag{4}
