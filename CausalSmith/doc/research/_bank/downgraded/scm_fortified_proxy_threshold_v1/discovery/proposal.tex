...
%  Locked parameters: qid=scm\_fortified\_proxy\_threshold, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{scm\_fortified\_proxy\_threshold} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=scm\_fortified\_proxy\_threshold
