...
%  Locked parameters: qid=stat\_cate\_levelset\_supermargin, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_cate\_levelset\_supermargin} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_cate\_levelset\_supermargin
