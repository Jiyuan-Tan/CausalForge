...
%  Locked parameters: qid=stat\_rosenbaum\_lf\_family\_minimax, specialization=stat
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_rosenbaum\_lf\_family\_minimax} / \texttt{stat}%
...
%   assignment, target, regression) precisely for qid=stat\_rosenbaum\_lf\_family\_minimax
%   specialization=stat. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
