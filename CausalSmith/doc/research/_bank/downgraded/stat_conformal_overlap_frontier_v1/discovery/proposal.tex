...
%  Locked parameters: qid=stat\_conformal\_overlap\_frontier, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_conformal\_overlap\_frontier} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_conformal\_overlap\_frontier
