...
%  Locked parameters: qid=stat\_initiation\_time\_minimax\_frontier, specialization=shrinking\_window\_exact\_time
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_initiation\_time\_minimax\_frontier} / \texttt{shrinking\_window\_exact\_time}%
...
%   assignment, target, regression) precisely for qid=stat\_initiation\_time\_minimax\_frontier
%   specialization=shrinking\_window\_exact\_time. For a free-form qid (the
