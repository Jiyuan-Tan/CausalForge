...
\title{thmsmith Stage -1 proposal: \texttt{eid\_dml\_fold\_spectrum\_phase} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=eid\_dml\_fold\_spectrum\_phase
