...
For completeness, we record the expected-risk calculation under predictable inverse-propensity sampling.  On a cube of side \(b\), use the rescaled tensor-polynomial basis of degree \(\lfloor u\rfloor\).  For arm \(a\), multiply every empirical Gram-matrix contribution by
