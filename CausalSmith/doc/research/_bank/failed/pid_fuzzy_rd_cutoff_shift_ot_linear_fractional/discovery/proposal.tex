...
%  Locked parameters: qid=pid\_fuzzy\_rd\_cutoff\_shift, specialization=ot\_linear\_fractional
%
...
\title{causalsmith Stage -1 proposal: \texttt{pid\_fuzzy\_rd\_cutoff\_shift} / \texttt{ot\_linear\_fractional}%
...
%   assignment, target, regression) precisely for qid=pid\_fuzzy\_rd\_cutoff\_shift
%   specialization=ot\_linear\_fractional. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
