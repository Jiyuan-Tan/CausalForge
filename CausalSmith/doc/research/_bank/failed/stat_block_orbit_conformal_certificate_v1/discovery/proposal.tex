...
%  Locked parameters: qid=stat\_block\_orbit\_conformal\_certificate, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{stat\_block\_orbit\_conformal\_certificate} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=stat\_block\_orbit\_conformal\_certificate
