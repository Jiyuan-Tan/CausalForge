...
As in the symmetric proposition, the argument uses only global \(\mathcal G\)-orbits. Any pair-labelled application is conditional on the local subgroup inclusion in \(\texttt{def:pair-action}\).