...
%  Locked parameters: qid=scm\_prox\_recant\_pid, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{scm\_prox\_recant\_pid} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=scm\_prox\_recant\_pid
