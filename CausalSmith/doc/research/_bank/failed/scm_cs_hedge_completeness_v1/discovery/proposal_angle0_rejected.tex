...
%  Locked parameters: qid=scm\_cs\_hedge\_completeness, specialization=v1
%
...
\title{causalsmith Stage -1 proposal: \texttt{scm\_cs\_hedge\_completeness} / \texttt{v1}%
...
%   assignment, target, regression) precisely for qid=scm\_cs\_hedge\_completeness
