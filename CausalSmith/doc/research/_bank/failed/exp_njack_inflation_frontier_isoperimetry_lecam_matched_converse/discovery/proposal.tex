...
%  Locked parameters: qid=exp\_njack\_inflation\_frontier, specialization=isoperimetry\_lecam\_matched\_converse
%
...
\title{causalsmith Stage -1 proposal: \texttt{exp\_njack\_inflation\_frontier} / \texttt{isoperimetry\_lecam\_matched\_converse}%
...
%   assignment, target, regression) precisely for qid=exp\_njack\_inflation\_frontier
%   specialization=isoperimetry\_lecam\_matched\_converse. Only for a legacy numbered qid (`q1_*`, etc.),
%   use the retired Q1 pool-mode and
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
