...
%  Locked parameters: qid=pid\_alwaystaker\_adrf\_sharp\_conditional, specialization=frechet\_fractional\_program
%
...
\title{thmsmith Stage -1 proposal: \texttt{pid\_alwaystaker\_adrf\_sharp\_conditional} / \texttt{frechet\_fractional\_program}%
...
%   assignment, target, regression) precisely for qid=pid\_alwaystaker\_adrf\_sharp\_conditional
%   specialization=frechet\_fractional\_program. If this maps to the Q1 pool-mode,
%   reproduce that block VERBATIM from
%   CausalSmith/doc/panel_formula_question_generator_note_with_common_prompts.tex
