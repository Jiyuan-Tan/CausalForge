...
%   assignment, target, regression) precisely for qid=pid\_network\_exposure\_aliasing\_graphpair
...
% item 4 in `CausalSmith/tools/src/discovery/prompts/stage_neg1_2_draft.txt` for full details.
%
