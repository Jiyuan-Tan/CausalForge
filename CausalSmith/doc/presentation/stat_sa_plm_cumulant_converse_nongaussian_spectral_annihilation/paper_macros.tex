...
\usepackage{amsmath}
\usepackage{amsthm}
% `framed` draws the page-breakable box around an `algorithmv` (no TikZ/tcolorbox dependency).
\usepackage{framed}
...
\newtheorem{algorithmbox}{Algorithm}
...
\NewDocumentEnvironment{algorithmv}{m o s}{\begin{framed}\begin{algorithmbox}\label{obj:#1}{\normalfont[\texttt{\detokenize{#1}}]\IfValueT{#2}{\ (#2)}\IfBooleanT{#3}{\verificationfootnotemark}\ }}{\end{algorithmbox}\end{framed}}
